...
- Update chuscraper/_version.py with the new version number
...
- Commit and push changes to pyproject.toml, uv.lock, chuscraper/_version.py, and CHANGELOG.md
...
GITHUB_REPO_SLUG = "cdpdriver/chuscraper"

PYPROJECT_TOML = Path("pyproject.toml")
PYPROJECT_VERSION_REGEX = r"^version = \"(?P<version>\d+\.\d+\.\d+)\"$"

VERSION_PY = Path("chuscraper/_version.py")
