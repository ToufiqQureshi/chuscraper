...
from chuscraper.engine.core._types import Any, Dict, Iterable, List
...
def setup_logger():
    logger = logging.getLogger("chuscraper.engine")
...
_current_logger: ContextVar[logging.Logger] = ContextVar("chuscraper_engine_logger", default=setup_logger())
